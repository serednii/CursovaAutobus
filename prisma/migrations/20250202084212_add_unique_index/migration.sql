...
CREATE TABLE "BusSeat" (
    ...
    CONSTRAINT "BusSeat_routeDriverId_fkey" FOREIGN KEY ("routeDriverId") REFERENCES "RouteDriver" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "PassengersSeatsList" (
    ...
    "routeDriverId" INTEGER NOT NULL,
    CONSTRAINT "PassengersSeatsList_idPassenger_fkey" FOREIGN KEY ("idPassenger") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "PassengersSeatsList_routeDriverId_fkey" FOREIGN KEY ("routeDriverId") REFERENCES "RouteDriver" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "SubPassengersList" (
    ...
    CONSTRAINT "SubPassengersList_passengersSeatsListId_fkey" FOREIGN KEY ("passengersSeatsListId") REFERENCES "PassengersSeatsList" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "IntermediateStop" (
    ...
    "routeId" INTEGER,
    CONSTRAINT "IntermediateStop_routeId_fkey" FOREIGN KEY ("routeId") REFERENCES "RouteDriver" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "PassengersSeatsList_routeDriverId_idPassenger_key" ON "PassengersSeatsList"("routeDriverId", "idPassenger");
